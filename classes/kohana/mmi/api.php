...
abstract class Kohana_MMI_API
{
	 ...
	 * Returns a SimpleXMLElement object or an associative array depending on
	 * the value of the _decode_as_array property.
	 *
	 * @param	string	the response string
	 * @param	boolean	return the decoded results as an associative array?
	 * @return	mixed
	...
	/**
	 * Ensure a valid MMI_Curl_Response object was received and check the
	 * HTTP status code.
	 *
