...
//		$response = $svc->get('http://memakeit.tumblr.com/api/read');
		...
		$requests = array
		(
			'posts' => array('url' => 'http://memakeit.tumblr.com/api/read'),
			'pages' => array('url' => 'http://memakeit.tumblr.com/api/pages'),
			'posts (private)' => array('method' => MMI_HTTP::METHOD_POST, 'url' => 'http://memakeit.tumblr.com/api/read', 'parms' => array('email' => $email, 'password' => $password)),
